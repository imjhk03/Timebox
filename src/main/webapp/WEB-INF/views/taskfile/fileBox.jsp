...
<title>Timebox - 자료실</title>
</head>
<script>

	function addFile() {
		winobj = window.open('faddFile', "winobj", "toolbar=no,menubar=no,width=350,height=40")
	}
</script>
	...
	<div id="section">
		<div id="page-content">
			...
			<div id="fileBrowse">
				...
				<form name="form2" method="post" action="down">
				<div id="fileContent">
					...
					<ol id="fileList">
						...
						<li class="browse-file">
							...
							<div class="flist-checkbox"><input type="checkbox" class="flist-chkbox" name="filename" value="${file.f_name}"></div>
							<div class="flist-name"><img src="http://i.imgur.com/D2UCk1m.png" />${file.f_name}</div>
							<div class="flist-date">${file.f_date }</div>
